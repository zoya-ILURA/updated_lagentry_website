...
// If the key is missing, we still provide a non-empty placeholder string so that
// Supabase doesn't throw at import time. Real projects should override this via .env.
const supabaseKey =
